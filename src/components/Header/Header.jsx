  ...
  return (
    ...
    <header className={s.header}>
        <div className="container">
            <nav className={s.nav}>
                <img className={s.burger} onClick={toggleMenu} src="https://cdn-icons-png.flaticon.com/512/6499/6499731.png" alt="" />
                <Link to={'/'} className={s.logo} > 
                 SHOP.CO
                 </Link>

                <div className={`${s.menu} ${isActive ? s.active : null}`}>
                    <Link onClick={closeMenu} className={s.dropdown} to={'/shop'}>Shop
                        <svg
                            width="16"
                            height="16"
                            viewBox="0 0 16 16"
